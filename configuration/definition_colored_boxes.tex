...
\newenvironment{cleancode}{\begin{tBox}
                               \begin{cleancodeT}}{\end{cleancodeT}
\end{tBox}}
...
\end{exampleT}}
\newenvironment{important}{\begin{iBox}
                               \begin{importantT}}{
...
% Check if needed?
%\newenvironment{problem}{\begin{tBox}
%                             \begin{problemT}}{\end{problemT}
%\end{tBox}}
